...
//VAR
//BEGIN
	O2M_RESULT = rectangle::Perimeter(r->O2M_SPEC_rect);
	goto O2M_RETURN;
	O2M_RETURN:;
	return O2M_RESULT;
}
...
//VAR
//BEGIN
	O2M_RESULT = triangle::Perimeter(t->O2M_SPEC_trian);
	goto O2M_RETURN;
	O2M_RETURN:;
	return O2M_RESULT;
}
...
//VAR
//BEGIN
	rectangle::Output(r->O2M_SPEC_rect);
}
//END Output;
...
//VAR
//BEGIN
	triangle::Output(t->O2M_SPEC_trian);
}
//END Output;
...
//VAR
//BEGIN
	rectangle::FileOutput(outFile, r->O2M_SPEC_rect);
}
//END FileOutput;
...
//VAR
//BEGIN
	triangle::FileOutput(outFile, t->O2M_SPEC_trian);
}
//END FileOutput;
