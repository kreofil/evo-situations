...
int main() {
  std::cout << "App 1: Launched with the ConcreteCreator1.\n";
  Creator* creator = new ConcreteCreator1();
  ClientCode(*creator);
  std::cout << std::endl;
  std::cout << "App 2: Launched with the ConcreteCreator2.\n";
  Creator* creator2 = new ConcreteCreator2();
  ClientCode(*creator2);

  std::cout << std::endl;
  std::cout << "App 3: Launched with the ConcreteCreator1.\n";
  ConcreteCreator1 creator3;
  ClientCode(creator3);
  std::cout << std::endl;
  std::cout << "App 4: Launched with the ConcreteCreator2.\n";
  ConcreteCreator2 creator4;
  ClientCode(creator4);
