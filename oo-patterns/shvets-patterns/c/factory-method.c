...
Product* FactoryMethod(Creator c) {
  switch (c) {
    case ConcreteCreator1: return FactoryMethodCreator1();
    case ConcreteCreator2: return FactoryMethodCreator2();
    default: return NULL;
  }
}
...
int main() {
  ...
  Creator* creator1 = malloc(sizeof(Creator)); *creator1 = ConcreteCreator1;
  ClientCode(*creator1);
  printf("\n");
  printf("App: Launched with the ConcreteCreator2.\n");
  Creator* creator2 = malloc(sizeof(Creator)); *creator2 = ConcreteCreator2;
  ClientCode(*creator2);
  free(creator1);
  free(creator2);
  ...
  printf("\n");
  printf("App: Launched with the ConcreteCreator1.\n");
  Creator creator3 = ConcreteCreator1;
  ClientCode(creator3);
  printf("\n");
  printf("App: Launched with the ConcreteCreator2.\n");
  Creator creator4 = ConcreteCreator2;
  ClientCode(creator4);
