...
//=================================================
// Диспетчеризация для периметров

// Старт диспетчеризации периметров, когда первый тип - прямоугольник
func (r1 *Rectangle)MMP(f2 Figure) float64 {
  return f2.RectangleContinuePerimeter(r1)
}

//-------------------------------------------------
// Старт диспетчеризации, когда первый тип - треугольник
func (t1 *Triangle) MMP(f2 Figure) float64 {
  return f2.TriangleContinuePerimeter(t1)
}
...
// Продолжение диспетчеризации, когда после прямоугольника
// идет прямоугольник
func (r2 *Rectangle) RectangleContinuePerimeter(r1 *Rectangle) float64 {
