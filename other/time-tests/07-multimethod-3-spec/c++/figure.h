...
public:
  ...
  virtual double MultimethodPerimeter(Figure& fig2) = 0; // мультиметод
  virtual double FirstRectanglePerimeter(Rectangle& rect) = 0;
  virtual double FirstTrianglePerimeter(Triangle& trian) = 0;
  virtual double FirstCirclePerimeter(Circle& circ) = 0;
};
