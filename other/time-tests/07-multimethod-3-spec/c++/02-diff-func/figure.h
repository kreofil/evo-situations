...
public:
  ...
  virtual int MultimethodDifFunc(Figure& fig2) = 0; // мультиметод
  virtual int FirstRectangleDifFunc(Rectangle& rect) = 0;
  virtual int FirstTriangleDifFunc(Triangle& trian) = 0;
  virtual int FirstCircleDifFunc(Circle& circ) = 0;
};
