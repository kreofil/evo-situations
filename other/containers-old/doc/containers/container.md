...
```
## desc 
Обобщенная структура, специализациями которой, являются все структуры данных в библиотеке
...
Многие из обобщенных функций, не реализованны для всех специализаций контейнеров (HashSet не должен иметь метода PopBackContainer), При вызове функции с аргументом специализированным контейнером, будет выведена в поток ошибок соответствующая информация.
