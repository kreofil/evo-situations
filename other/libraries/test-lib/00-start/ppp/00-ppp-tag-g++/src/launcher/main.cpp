...
extern "C" void ContainerInit(Container* c) ;
extern "C" void ContainerClear(Container* c);

extern "C" void ContainerIn(Container* c, FILE* ifst) ;
extern "C" void ContainerOut(Container* c, FILE* ofst) ;
