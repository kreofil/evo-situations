// Пример диспетчеризации с пятью аргументами и двумя альтернативами
...
public:
    ...
    virtual void mm(d0* x1,d0* x2,d0* x3,d0* x4);
    virtual void d0d1d2(); // Первый - это d0, второй - d1
    virtual void d1d0(); // Первый - это d1, второй - d0
};

void d0::mm(d0* x1,d0* x2,d0* x3,d0* x4) { x1->d0d1d2d3d4(); }
